    ...
    return (
        <div className="space-y-8 mt-20">
            ...
            >
                ...
                >
                    <Card className="relative overflow-hidden h-[450px] group shadow-lg transition-transform duration-300 hover:scale-[1.05] service-card">
                        <img
                            src="/1.jpg"
                            alt="Fußmassage"
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8">
                            <div className="space-y-2">
                                <div className="text-white/80 text-sm font-mono uppercase tracking-wider">02</div>
                                <h3 className="text-white text-4xl font-bold text-balance">Fußmassage</h3>
                                <p className="text-white/90 text-sm leading-relaxed">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                <p className="text-white/95 text-base leading-relaxed font-medium">
                                    Bei Derma-Fuß steht die Gesundheit und Pflege Ihrer Füße im Mittelpunkt.
                                </p>
                        ...
                        <div className="space-y-6">
                            <div className="grid grid-cols-2 gap-x-8 gap-y-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <div className="font-medium">Seniorenfußpflege</div>
                                </div>
                                <div>
                                    <div className="text-xs text-muted-foreground font-mono mb-1">06</div>
                                    <div className="font-medium">Fußpflegeberatung</div>
                                </div>
                            </div>
                            ...
                            <div className="pt-4 border-t border-border">
                                ...
                                <div className="space-y-2 text-sm text-muted-foreground">
                                    ...
                                    <div className="flex justify-between items-center">
                                        <span>Individuelle Fußpflegeempfehlungen</span>
                                        <span className="text-xs font-mono">✓</span>
                                    </div>
                                </div>
                            </div>
